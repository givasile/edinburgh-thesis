...
approximations. The argument \pinline{step} defines the step used in the
Riemann's approximation and the argument \pinline{distance} can take
either the \pinline{Jensen-Shannon} or the \pinline{KL-divergence}
