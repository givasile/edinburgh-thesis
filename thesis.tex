...
demonstrate hpow a practitioner could use our ROMC implementation for
performing the inference in an simulator-based model. For providing a
...
implementation. This Section mainly refers to a \textbf{researcher or
  a developer} who would like to use ROMC as a meta-algorithm and
...
method without too much effort. This Section contains as well a driver
example for extending the method with custom utilities.


\subsection{General Design}
\label{subsec:general_design}
% \input{ch3/generalDesign}
