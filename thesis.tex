...
two logical blocks; In Sections~\ref{subsec:general_design} to
\ref{subsec:evaluation} we present the functionalities provided from
the \emph{user's point-of-view}. These sections demonstrate how a
...
\item add parallelisation description.
  \item uncapitalise all section
\end{itemize}
l
\printbibliography
\clearpage
